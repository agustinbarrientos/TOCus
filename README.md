...
TOCus v1 is local-only. Selected-site settings and pause interactions stay on your device. V1 has no account, TOCus server, telemetry or product analytics, browsing-history permission or analysis, and the extension makes no network requests for core operation. This promise does not describe traffic generated by a protected website.
