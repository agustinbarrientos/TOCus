...
Bug reports, translations, design feedback, and code contributions are welcome. See [CONTRIBUTING.md](CONTRIBUTING.md) for development setup and contribution guidance, and [CHANGELOG.md](CHANGELOG.md) for project changes.
