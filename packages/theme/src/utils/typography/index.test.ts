...
const TYPOGRAPHY_ROLES = [
	...
	{ role: 'title-large', values: [ 'var(--tocus-font-family-brand)', 'calc(var(--tocus-size-unit) * 1.58125)', '600', 'calc(var(--tocus-size-unit) * 2.0125)', '0' ] },
	{ role: 'title-medium', values: [ 'var(--tocus-font-family-brand)', 'calc(var(--tocus-size-unit) * 1.15)', '600', 'calc(var(--tocus-size-unit) * 1.725)', 'calc(var(--tocus-size-unit) * 0.01078125)' ] },
	{ role: 'title-small', values: [ 'var(--tocus-font-family-brand)', 'calc(var(--tocus-size-unit) * 1.00625)', '600', 'calc(var(--tocus-size-unit) * 1.4375)', 'calc(var(--tocus-size-unit) * 0.0071875)' ] },
