...
const FALLBACK_COLOR_TOKENS = [
	...
	'--tocus-color-divider',
	'--tocus-color-danger',
	'--tocus-color-on-danger',
	'--tocus-color-danger-hover',
	'--tocus-color-success-surface',
	'--tocus-color-on-success',
	'--tocus-color-success-border',
	'--tocus-color-error-surface',
	'--tocus-color-on-error',
	'--tocus-color-warning-surface',
	'--tocus-color-on-warning',
	'--tocus-color-warning-border',
