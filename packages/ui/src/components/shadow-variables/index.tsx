...
import { tocusCssVariables } from '../../utils/theme';
import { createShadowStyleSheet, observeShadowInlineLengths } from '../../services/shadow-styles';
import { TocusAppearance } from '../provider/types';
import type { ShadowVariablesProps } from './types';
