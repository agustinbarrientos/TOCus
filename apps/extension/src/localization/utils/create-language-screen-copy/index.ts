...
export function createLanguageScreenCopy( i18n: I18n ): Readonly<LanguageScreenCopy> {
	...
	return Object.freeze( {
		...
		malformedDataDescription: i18n._(
			msg`Your local personalization data isn't valid. Restoring defaults will reset appearance, pause, motion, and language preferences.`,
		),
		loadErrorTitle: i18n._( msg`Language settings couldn't load` ),
		loadErrorDescription: i18n._( msg`TOCus couldn't load your local language setting. Nothing was changed.` ),
		...
		saveError: i18n._( msg`Your language couldn't be saved. Your choice is still shown here.` ),
