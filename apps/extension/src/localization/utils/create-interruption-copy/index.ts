...
export function createInterruptionCopy( i18n: I18n ): Readonly<InterruptionScreenCopy> {
	...
	return Object.freeze( {
		...
		readyAnnouncement: i18n._( msg`You can continue when you're ready.` ),
		readyExpiredMessage: i18n._( msg`This visit window has ended. Start another pause when you're ready.` ),
		recoveryFailedAnnouncement: i18n._( msg`TOCus still couldn't restore this pause.` ),
		...
		unavailableMessage: i18n._( msg`TOCus couldn't restore this pause.` ),
