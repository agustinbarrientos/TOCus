...
import type { LocalDate, ProtectionScopeId } from '../../types/protection-value';
...
export interface PrepareStatisticsDeliveryForTransitionInput {
	...
	/** Captured date, or null for event kinds that cannot emit facts. */
	observedLocalDate: LocalDate | null;
