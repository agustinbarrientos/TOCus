...
export interface WebsiteCatalog {
	...
	statsTitle: string;
	statsEstimated: string;
	statsFocused: string;
	statsReconsidered: string;
	statsCompleted: string;
	statsAllowances: string;
	statsPeriod: string;
	statsAllTime: string;
	statsThisMonth: string;
	statsThisWeek: string;
	statsApproximate: string;
	statsActivity: string;
	statsDate: string;
	statsEstimateDescription: string;
	mediaTitle: string;
	...
	privacyAdvertising: string;
	demoPopularChoices: string;
	demoAddAnotherSite: string;
	demoAddSite: string;
	demoAddress: string;
	demoAddressPlaceholder: string;
	demoFinishSetup: string;
	demoContinueShortcut: string;
	demoSpaceKey: string;
	demoAllowanceMinutes: string;
	demoVideoTitle: string;
	demoVideoChannel: string;
	privacyCalls: string;
	privacyLocal: string;
	...
	freeLabel: string;
	mascotAlt: string;
	mascotInteractionLabel: string;
	demoLabel: string;
	demoNewTab: string;
	demoReady: string;
	demoTakeAMoment: string;
	demoBreatheIn: string;
	demoBreatheOut: string;
	demoContinue: string;
	demoSphere: string;
	demoSecondsRemaining: string;
