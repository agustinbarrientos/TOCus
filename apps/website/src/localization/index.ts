...
function createWebsiteCatalog( i18n: I18n ): Readonly<WebsiteCatalog> {
	return Object.freeze( {
		...
		sitesTitle: i18n._( msg`Set a schedule for each site` ),
		sitesDescription: i18n._( msg`If you feel like it, pick different days and times for each site.` ),
		...
		privacyLocal: i18n._( msg`It's 100% private` ),
