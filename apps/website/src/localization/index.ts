...
function createWebsiteCatalog( i18n: I18n ): Readonly<WebsiteCatalog> {
	return Object.freeze( {
		...
		privacy: i18n._( msg`Settings and statistics stay in your browser. Works offline, without an account.` ),
		howTitle: i18n._( msg`How it works` ),
		...
		mediaDescription: i18n._( msg`Videos pause during the wait and resume when you continue.` ),
		mediaServices: i18n._( msg`YouTube, Netflix, Twitch and more` ),
		statisticsTitle: i18n._( msg`See how much time you saved` ),
		statisticsDescription: i18n._( msg`See completed pauses and reconsidered visits.` ),
		statisticsExample: i18n._( msg`Example: 24h 40m reclaimed / 254 reconsidered visits` ),
		privacyLocal: i18n._( msg`Stored on your device` ),
		openSourceTitle: i18n._( msg`Free and open source` ),
		openSourceDescription: i18n._( msg`Read the code, suggest changes, or make it your own. No advertising.` ),
		alsoAvailable: i18n._( msg`Also available on` ),
		comingSoon: i18n._( msg`Coming soon` ),
		downloadTitle: i18n._( msg`Take a little pause.` ),
