...
function createWebsiteCatalog( i18n: I18n ): Readonly<WebsiteCatalog> {
	return Object.freeze( {
		...
		storyPlay: i18n._( msg`Play walkthrough` ),
		storyPause: i18n._( msg`Pause walkthrough` ),
		storyReplay: i18n._( msg`Replay walkthrough` ),
		chooseTitle: i18n._( msg`Choose your sites` ),
		chooseDescription: i18n._( msg`TOCus pauses before opening the websites you add.` ),
		...
		browseTitle: i18n._( msg`Browse until the next pause` ),
		...
		appearanceDescription: i18n._( msg`Six palettes with light, dark, or system appearance. Motion follows your operating system's reduced motion setting.` ),
		statisticsTitle: i18n._( msg`See how much time you saved` ),
		statisticsDescription: i18n._( msg`See counts of completed pauses and reconsidered visits.` ),
		statsTitle: i18n._( msg`Statistics` ),
		statsEstimated: i18n._( msg`Estimated time reclaimed` ),
		statsFocused: i18n._( msg`Time you took to pause` ),
		statsReconsidered: i18n._( msg`Reconsidered visits` ),
		statsCompleted: i18n._( msg`Completed waits` ),
		statsAllowances: i18n._( msg`Allowances granted` ),
		statsPeriod: i18n._( msg`Period` ),
		statsAllTime: i18n._( msg`All time` ),
		statsThisMonth: i18n._( msg`Current month` ),
		statsThisWeek: i18n._( msg`Current week` ),
		statsApproximate: i18n._( { ...msg`Approximately {time}`, values: { time: '{time}' } } ),
		statsActivity: i18n._( msg`Activity` ),
		statsDate: i18n._( msg`Date` ),
		statsEstimateDescription: i18n._( msg`Time spent pausing plus estimated browsing time avoided, based on your configured visit time.` ),
		mediaTitle: i18n._( msg`Your video pauses, too` ),
		mediaDescription: i18n._( msg`TOCus pauses playing videos on supported sites during the wait and resumes them when you continue.` ),
		sitesTitle: i18n._( msg`Custom schedules for each site` ),
		sitesDescription: i18n._( msg`Choose different active days and hours for each website.` ),
		privacyTitle: i18n._( msg`Private and safe` ),
		privacyAccounts: i18n._( msg`You can use TOCus without an account.` ),
		privacyTracking: i18n._( msg`The extension has no analytics.` ),
		privacyAdvertising: i18n._( msg`The extension has no advertising.` ),
		privacyCalls: i18n._( msg`The extension does not contact external services.` ),
		privacyLocal: i18n._( msg`Stored on your device` ),
		...
		mascotAlt: i18n._( msg`A capybara relaxing in a beach chair` ),
		mascotInteractionLabel: i18n._( msg`Interact with the capybara` ),
		demoLabel: i18n._( msg`How TOCus works` ),
		demoNewTab: i18n._( msg`New tab` ),
		demoReady: i18n._( msg`Ready when you are` ),
		demoTakeAMoment: i18n._( msg`Take a moment` ),
		demoBreatheIn: i18n._( msg`Breathe in` ),
		demoBreatheOut: i18n._( msg`Breathe out` ),
		demoContinue: i18n._( msg`Continue` ),
		demoSphere: i18n._( msg`Breathing guide` ),
		demoSecondsRemaining: i18n._( { ...msg`{seconds}s`, values: { seconds: '{seconds}' } } ),
		demoPopularChoices: i18n._( msg`Popular choices` ),
		demoAddAnotherSite: i18n._( msg`Add another site` ),
		demoAddSite: i18n._( msg`Add site` ),
		demoAddress: i18n._( msg`Website address` ),
		demoAddressPlaceholder: i18n._( msg`example.com` ),
		demoFinishSetup: i18n._( msg`Finish setup` ),
		demoContinueShortcut: i18n._( { ...msg`Or press {key}`, values: { key: '{key}' } } ),
		demoSpaceKey: i18n._( msg`Space` ),
		demoAllowanceMinutes: i18n._( { ...msg`{minutes}m`, values: { minutes: '{minutes}' } } ),
		demoVideoTitle: i18n._( msg`A quiet afternoon` ),
		demoVideoChannel: i18n._( msg`Slow days` ),
		...
		privacyShort: i18n._( msg`No account is needed to use the extension.` ),
