...
function createWebsiteCatalog( i18n: I18n ): Readonly<WebsiteCatalog> {
	return Object.freeze( {
		...
		statisticsTitle: i18n._( msg`Your pauses, over time.` ),
		...
		sitesDescription: i18n._( msg`Choose different active days and hours for each website. Pause timing applies to all your selected sites.` ),
		privacyTitle: i18n._( msg`Privacy in your browser.` ),
		privacyAccounts: i18n._( msg`You can use TOCus without an account.` ),
		privacyTracking: i18n._( msg`The extension has no analytics or advertising.` ),
		...
		mascotAlt: i18n._( msg`A smiling capybara` ),
